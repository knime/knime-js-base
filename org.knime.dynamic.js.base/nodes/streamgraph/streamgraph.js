(streamgraph_namespace = function() {
  ...
  var drawChart = function(redraw) {
    ...
    nv.addGraph(function() {
      chart = nv.models.stackedAreaChart()
        ...
        // TODO: "stream-center" gives weird interactive guideline!
        .style("stream")
        .showControls(false)
  ...
  var setColors = function() {
    ...
    if (customColors && knimeTable2 !== null) {
      ...
      for (var i = 0; i < numColumns; i++) {setColors
  ...
  var drawControls = function() {
    ...
    if (_representation.options.enableInterpolationMethodEdit) {
      ...
      var interpolationMethodSelector = knimeService.createMenuSelect('interpolationMethodSelector', _value.options.interpolation, interpolationMethods, function() {
    ...
    if (customColorToggle || legendToggle || interactiveGuidelineToggle) {
      ...
      if (customColorToggle) {
        var customColorCheckbox = knimeService
          .createMenuCheckbox('customColorCheckbox', _value.options.customColors, function() {
            _value.options.customColors = this.checked;
            setColors();
            chart.color(_colorRange);
            chart.update();
          });
        knimeService.addMenuItem('Custom colors:', 'paint-brush', customColorCheckbox);
      }

      // TODO: This is not working.
      if (legendToggle) {
        var legendCheckbox = knimeService
          .createMenuCheckbox('legendCheckbox', _value.options.legend, function() {
      ...
      if (interactiveGuidelineToggle) {
        var interactiveGuidelineCheckbox = knimeService
          .createMenuCheckbox('interactiveGuidelineCheckbox', _value.options.interactiveGuideline, function() {
        ...
        knimeService.addMenuItem('Guideline:', 'bathtub', interactiveGuidelineCheckbox);
      }
    }
  };
