...
public final class MoleculeSketcherPreferenceUtil {
    ...
    static final String NAME_SELECTION_DEF =
        // TODO replace with direct reference to latest Ketcher extension in UIEXT-768
        MoleculeSketcherRegistry.getInstance().getMoleculeSketchers().get(0).getClass().getName();
