 ...
 * Mostly copied from MoleculeStringInputQuickFormValue
 *
 * @author Daniel Bogenrieder, KNIME AG, Zurich, Switzerland
 */
@JsonAutoDetect
@JsonTypeInfo(use = JsonTypeInfo.Id.CLASS, include = JsonTypeInfo.As.PROPERTY, property = "@class")
public class MoleculeWidgetValue extends JSONViewContent implements DialogNodeValue {
    ...
    public boolean equals(final Object obj) {
        ...
        MoleculeWidgetValue other = (MoleculeWidgetValue)obj;
