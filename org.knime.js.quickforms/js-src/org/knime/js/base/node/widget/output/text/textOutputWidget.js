 ...
 */
window.knimeTextOutputWidget = (function () {
    var textOutput = {
        version: '2.0.0'
    };
    textOutput.name = 'KNIME Text Output Widget';

    textOutput.init = function (representation) {
    ...
    textOutput.validate = function () {
        return true;
    };

    textOutput.setValidationErrorMessage = function (message) {
        /* nothing to display */
    };

    textOutput.value = function () {
        return null;
    };
