 ...
 */
window.knimeColumnSelectionWidget = (function () {
    
    var columnSelection = {
        version: '2.0.0'
    };
    columnSelection.name = 'KNIME Column Selection Widget';
    var selector;
    var viewValid = false;
    ...
    columnSelection.validate = function () {
        if (!viewValid) {
            return false;
        }
        return true;
    ...
    columnSelection.setValidationErrorMessage = function (message) {
        if (!viewValid) {
            return;
        }
        // TODO: display error
