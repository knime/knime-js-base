 ...
 */
window.knimeMultipleSelectionWidget = (function () {
    var multiSelection = {
        version: '2.0.0'
    };
    multiSelection.name = 'KNIME Multiple Selection Widget';
    var selector = null;
    var viewValid = false;
    ...
    multiSelection.validate = function () {
        if (!viewValid) {
            return false;
        }
        return true;
    ...
    multiSelection.setValidationErrorMessage = function (message) {
        if (!viewValid) {
            return;
        }
        // TODO: display error
