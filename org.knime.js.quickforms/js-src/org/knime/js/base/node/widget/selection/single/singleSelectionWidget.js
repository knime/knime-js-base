 ...
 *
 * History
 *   Jun 1, 2019 (Christian Albrecht, KNIME GmbH, Konstanz, Germany): created
 */
window.knimeSingleSelectionWidget = (function () {
    var singleSelection = {
        version: '2.0.0'
    };
    singleSelection.name = 'KNIME Single Selection Widget';
    var selector = null;
    var viewValid = false;
    ...
    singleSelection.validate = function () {
        if (!viewValid) {
            return false;
        }
        return true;
    ...
    singleSelection.setValidationErrorMessage = function (message) {
        if (!viewValid) {
            return;
        }
        // TODO: display error
