...
/**
 * Utility methods for the column filter Configuration and Widget nodes
 *
 * @author Christian Albrecht, KNIME GmbH, Konstanz, Germany
 */
public class ColumnFilterNodeUtil {

    /**
     * Create the outgoing {@link DataTableSpec} for column filter node models
     *
     * @param inSpec the incoming spec
     * @param columns the included columns
     * @return the (filtered) outgoing spec
     * @throws InvalidSettingsException on error
     */
    public static DataTableSpec createSpec(final DataTableSpec inSpec, final String[] columns)
