...
public class FileUploadNodeRepresentation<VAL extends FileUploadNodeValue> extends LabeledNodeRepresentation<VAL> {
    ...
    @JsonCreator
    protected FileUploadNodeRepresentation(@JsonProperty("label") final String label,
     ...
     */
    public FileUploadNodeRepresentation(final VAL currentValue, final VAL defaultValue,
        final FileUploadNodeConfig fileUploadConfig, final LabeledConfig labelConfig) {
    ...
    public boolean equals(final Object obj) {
        ...
        FileUploadNodeRepresentation<VAL> other = (FileUploadNodeRepresentation<VAL>)obj;
