...
/**
 * The base value for the column selection configuration and widget node
 *
 * @author Christian Albrecht, KNIME GmbH, Konstanz, Germany
 */
@JsonAutoDetect
@JsonTypeInfo(use = JsonTypeInfo.Id.CLASS, include = JsonTypeInfo.As.PROPERTY, property = "@class")
public class ColumnSelectionNodeValue extends JSONViewContent {
    ...
    public boolean equals(final Object obj) {
        ...
        ColumnSelectionNodeValue other = (ColumnSelectionNodeValue)obj;
