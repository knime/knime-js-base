...
/**
 * Represents the configuration that is used by a {@link ValidatorFactory} to create a {@link Validator}.
 *
...
public interface ValidatorConfig {
    ...
    /**
     * Saves the configuration to {@link NodeSettingsWO settings}.
     *
    ...
    /**
     * Loads the configuration from {@link NodeSettingsRO} for the execution in a node model.
     *
    ...
    /**
     * Loads the configuration from {@link NodeSettingsRO} for display in the dialog.
     *
     * @param settings the {@link NodeSettingsRO} to load from
     */
