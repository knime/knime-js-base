...
import org.knime.js.base.node.configuration.selection.multiple.MultipleSelectionDialogNodeParameters;
 ...
 * selection (i.e. {@link MultipleSelectionDialogNodeParameters}, and {@link ValueFilterDialogNodeParameters}).
 *
 * @author Robin Gerling
 */
public final class MultipleSelectionAndFilterNodeParametersUtil {

    private MultipleSelectionAndFilterNodeParametersUtil() {
    }
    ...
    /**
     * Effect which determines whether a list/twinlist is used as multiple selection component. Must be used with a
     * {@link SelectionTypeValueReference}
     */
    public static final class IsListOrTwinlistSelectionType implements EffectPredicateProvider {
        @Override
    ...
    /**
     * Choices provider returning the multiple selection component which should be attached to a String field with a
     * {@link SelectionTypeValueReference}
     */
