...
/**
 * Node model for the credentials configuration node
 *
...
public class CredentialsDialogNodeModel extends
     ...
     */
    @Override
    public CredentialsDialogNodeValue createEmptyDialogValue() {
    ...
    protected void createAndPushFlowVariable() throws InvalidSettingsException {
        final CredentialsDialogNodeValue value = getRelevantValue();
        validateDialogValue(value);
     ...
     */
    @Override
    public CredentialsDialogNodeConfig createEmptyConfig() {
        return new CredentialsDialogNodeConfig();
    }
    ...
    /** {@inheritDoc} */
    @Override
    public void validateDialogValue(final CredentialsDialogNodeValue viewContent) throws InvalidSettingsException {
        String username = viewContent.getUsername();
        if (username == null) {
            throw new InvalidSettingsException("no username set");
        }
        super.validateDialogValue(viewContent);
    }
