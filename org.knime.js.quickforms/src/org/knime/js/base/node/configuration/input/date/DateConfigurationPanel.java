...
/**
 * The component dialog panel for the date configuration node
 *
 * @author Christian Albrecht, KNIME GmbH, Konstanz, Germany
 */
@SuppressWarnings("serial")
public class DateConfigurationPanel extends AbstractDialogNodeConfigurationPanel<DateDialogNodeValue> {
    ...
    public DateConfigurationPanel(final DateDialogNodeRepresentation representation) {
        ...
        m_model = new SettingsModelDateTime("temp", representation.isUseDefaultExecTime()
     ...
     */
    @Override
    protected DateDialogNodeValue createNodeValue() throws InvalidSettingsException {
     ...
     */
    @Override
    public void loadNodeValue(final DateDialogNodeValue value) {
