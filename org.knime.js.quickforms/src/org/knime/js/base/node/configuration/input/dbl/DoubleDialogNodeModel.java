...
/**
 * Node model for the double configuration node
 *
...
public class DoubleDialogNodeModel
     ...
     */
    @Override
    public DoubleDialogNodeValue createEmptyDialogValue() {
     ...
     */
    @Override
    protected DoubleDialogNodeRepresentation getRepresentation() {
        return new DoubleDialogNodeRepresentation(getRelevantValue(), getConfig());
    }
