...
public class FileConfigurationPanel extends AbstractDialogNodeConfigurationPanel<FileUploadDialogNodeValue> {
     ...
     *
     */
    public FileConfigurationPanel(final FileDialogNodeRepresentation representation) {
