 ...
 */
public class FileUploadDialogNodeRepresentation extends FileUploadNodeRepresentation<FileUploadDialogNodeValue>
    implements SubNodeDescriptionProvider<FileUploadDialogNodeValue> {

    @JsonCreator
    private FileUploadDialogNodeRepresentation(@JsonProperty("label") final String label,
     ...
     */
    public FileUploadDialogNodeRepresentation(final FileUploadDialogNodeValue currentValue,
        final FileUploadInputDialogNodeConfig config) {
    ...
    public DialogNodePanel<FileUploadDialogNodeValue> createDialogPanel() {
        return new FileUploadConfigurationPanel(this);
    }
}
