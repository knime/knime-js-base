...
/**
 * Node model for the integer configuration node
 *
...
public class IntegerDialogNodeModel extends
     ...
     */
    @Override
    public IntegerDialogNodeValue createEmptyDialogValue() {
     ...
     */
    @Override
    protected IntegerDialogNodeRepresentation getRepresentation() {
        return new IntegerDialogNodeRepresentation(getRelevantValue(), getConfig());
    }
