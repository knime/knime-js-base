...
/**
 * The component dialog panel for the list box configuration node
 *
 * @author Christian Albrecht, KNIME GmbH, Konstanz, Germany
 */
@SuppressWarnings("serial")
public class ListBoxConfigurationPanel extends AbstractDialogNodeConfigurationPanel<ListBoxDialogNodeValue> {

    private JTextArea m_component = new JTextArea(5, DialogUtil.DEF_TEXTFIELD_WIDTH);
     ...
     */
    @Override
    protected ListBoxDialogNodeValue createNodeValue() throws InvalidSettingsException {
     ...
     */
    @Override
    public void loadNodeValue(final ListBoxDialogNodeValue value) {
