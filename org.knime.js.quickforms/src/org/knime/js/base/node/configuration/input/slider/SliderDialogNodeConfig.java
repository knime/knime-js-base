...
public class SliderDialogNodeConfig extends LabeledFlowVariableDialogNodeConfig<SliderDialogNodeValue> {
    ...
    private final SliderNodeConfig m_config;

    /**
     * Instantiate a new config object
     */
    public SliderDialogNodeConfig() {
        m_config = new SliderNodeConfig();
    }
    ...
    public SliderSettings getSliderSettings() {
        return m_config.getSliderSettings();
    }
    ...
    public void setSliderSettings(final SliderSettings sliderSettings) {
        m_config.setSliderSettings(sliderSettings);
    }
    ...
    public boolean isUseCustomMin() {
        return m_config.isUseCustomMin();
    }
    ...
    public void setUseCustomMin(final boolean useCustomMin) {
        m_config.setUseCustomMin(useCustomMin);
    }
    ...
    public boolean isUseCustomMax() {
        return m_config.isUseCustomMax();
    }
    ...
    public void setUseCustomMax(final boolean useCustomMax) {
        m_config.setUseCustomMax(useCustomMax);
    }
