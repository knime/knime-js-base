...
public class StringConfigurationPanel extends AbstractDialogNodeConfigurationPanel<StringDialogNodeValue> {
     ...
     */
    @Override
    protected StringDialogNodeValue createNodeValue() throws InvalidSettingsException {
     ...
     */
    @Override
    public void loadNodeValue(final StringDialogNodeValue value) {
