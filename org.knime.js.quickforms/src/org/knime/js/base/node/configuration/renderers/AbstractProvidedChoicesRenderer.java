 ...
 */
abstract class AbstractProvidedChoicesRenderer implements ControlRendererSpec {

    private final String m_title;

    private final StateProvider<List<StringChoice>> m_possibleValues;

    AbstractProvidedChoicesRenderer(final String title, final StateProvider<List<StringChoice>> possibleValues) {
        m_title = title;
    ...
    public Map<String, StateProvider<?>> getStateProviders() {
        return Map.of("possibleValues", m_possibleValues);
    }
