...
abstract class AbstractRepresentationLayoutRenderer implements LayoutRendererSpec {

    SubNodeDescriptionProvider<?> m_rep;

    AbstractRepresentationLayoutRenderer(final SubNodeDescriptionProvider<?> rep) {
        m_rep = rep;
    }

    @Override
    public Optional<String> getLabel() {
        return Optional.of(m_rep.getLabel());
    }
