...
import org.knime.core.webui.node.dialog.defaultdialog.jsonforms.renderers.ColumnFilterRendererSpec;
 ...
 */
public class ColumnFilterRenderer extends SubNodeDescriptionProviderRenderer implements ColumnFilterRendererSpec {
     ...
     */
    public ColumnFilterRenderer(final SubNodeDescriptionProvider<?> nodeRep, final boolean hasSizeLimit,
        final int sizeLimit) {
        super(nodeRep);
    ...
    @Override
    public Optional<ColumnFilterRendererOptions> getOptions() {
        return Optional.of(new ColumnFilterRendererOptions() {
            @Override
