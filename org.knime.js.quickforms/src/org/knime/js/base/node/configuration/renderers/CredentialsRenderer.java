...
import org.knime.js.base.node.configuration.input.credentials.CredentialsDialogNodeRepresentation;
import org.knime.js.base.node.configuration.input.string.StringDialogNodeRepresentation;

/**
 * A non-localized credentials renderer for {@link StringDialogNodeRepresentation}s.
 *
...
public class CredentialsRenderer extends AbstractRepresentationRenderer implements CredentialsRendererSpec {
    ...
    /**
     * Creates a new credentials renderer.
     *
     * @param credentialsDialogRep the representation of the node
     */
    public CredentialsRenderer(final CredentialsDialogNodeRepresentation credentialsDialogRep) {
        super(credentialsDialogRep);
        m_credentialsDialogRep = credentialsDialogRep;
    }
    ...
    public Optional<CredentialsRendererOptions> getOptions() {
        return Optional.of(new CredentialsRendererOptions() {
            ...
            public Optional<String> getUsernameLabel() {
                return Optional.ofNullable(m_credentialsDialogRep.getUsernameLabel());
            }
