...
/**
 * Dropdown with a title and provided possible values.
 *
 * @author Paul Bärnreuther
 */
public final class ProvidedChoicesDropdownRenderer extends AbstractProvidedChoicesRenderer
    implements DropdownRendererSpec {
     ...
     */
    public ProvidedChoicesDropdownRenderer(final String title, final StateProvider<List<StringChoice>> possibleValues) {
