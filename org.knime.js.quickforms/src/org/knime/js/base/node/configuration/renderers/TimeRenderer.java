...
import org.knime.core.webui.node.dialog.defaultdialog.jsonforms.renderers.LocalDateTimeRendererSpec.LocalDateTimeRendererOptions;
...
/**
 * A time renderer for {@link DateDialogNodeRepresentation}s when the type is {@link DateTimeType#LOCAL_TIME}.
 *
...
public class TimeRenderer extends SubNodeDescriptionProviderRenderer implements TimeRendererSpec {
    ...
    /**
     * Creates a new time renderer for the given {@link DateDialogNodeRepresentation}.
     *
     * @param dateDialogRep the representation of the node
     */
    public TimeRenderer(final DateDialogNodeRepresentation dateDialogRep) {
        super(dateDialogRep);
        m_dateDialogRep = dateDialogRep;
    }

    @Override
    public Optional<TimeRendererOptions> getOptions() {
        return Optional.of(new LocalDateTimeRendererOptions() {
