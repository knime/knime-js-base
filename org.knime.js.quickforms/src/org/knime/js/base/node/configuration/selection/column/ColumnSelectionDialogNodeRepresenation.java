...
import org.knime.js.base.node.configuration.renderers.SingleEntrySelectionRendererUtil;

import com.fasterxml.jackson.annotation.JsonCreator;
import com.fasterxml.jackson.annotation.JsonProperty;

/**
 * The dialog representation of the column selection configuration node
 *
...
public class ColumnSelectionDialogNodeRepresenation
     ...
     */
    public ColumnSelectionDialogNodeRepresenation(final ColumnSelectionDialogNodeValue currentValue,
        final ColumnSelectionDialogNodeConfig config) {
        super(currentValue, config.getDefaultValue(), config.getColumnSelectionConfig(), config.getLabelConfig());
    }
