...
/**
 * Node model for the multiple selection configuration node
 *
 * @author Christian Albrecht, KNIME GmbH, Konstanz, Germany
 */
public class MultipleSelectionDailogNodeModel extends DialogNodeModel<MultipleSelectionDialogNodeRepresentation,
    MultipleSelectionDialogNodeValue, MultipleSelectionDialogNodeConfig> {

    /**
     * Creates a new multiple selection configuration node model
     */
    public MultipleSelectionDailogNodeModel() {
     ...
     */
    @Override
    public MultipleSelectionDialogNodeValue createEmptyDialogValue() {
        return new MultipleSelectionDialogNodeValue();
    }
     ...
     */
    @Override
    public MultipleSelectionDialogNodeConfig createEmptyConfig() {
        return new MultipleSelectionDialogNodeConfig();
    }
     ...
     */
    @Override
    protected MultipleSelectionDialogNodeRepresentation getRepresentation() {
        return new MultipleSelectionDialogNodeRepresentation(getRelevantValue(), getConfig());
    }
