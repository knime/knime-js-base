...
/**
 * The config for the multiple selection configuration node
 *
 * @author Christian Albrecht, KNIME GmbH, Konstanz, Germany
 */
public class MultipleSelectionDialogNodeConfig
    extends LabeledFlowVariableDialogNodeConfig<MultipleSelectionDialogNodeValue> {
     ...
     */
    public MultipleSelectionDialogNodeConfig() {
     ...
     */
    @Override
    protected MultipleSelectionDialogNodeValue createEmptyValue() {
    ...
    public boolean equals(final Object obj) {
        ...
        MultipleSelectionDialogNodeConfig other = (MultipleSelectionDialogNodeConfig)obj;
