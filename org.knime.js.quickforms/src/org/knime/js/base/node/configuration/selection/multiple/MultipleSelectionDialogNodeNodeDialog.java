...
/**
 * The dialog for the multiple selection configuration node
 *
 * @author Christian Albrecht, KNIME GmbH, Konstanz, Germany
 */
public class MultipleSelectionDialogNodeNodeDialog
    extends FlowVariableDialogNodeNodeDialog<MultipleSelectionDialogNodeValue> {
    ...
    private final MultipleSelectionDialogNodeConfig m_config;

    /**
     * Constructor, inits fields calls layout routines
     */
    public MultipleSelectionDialogNodeNodeDialog() {
        m_config = new MultipleSelectionDialogNodeConfig();
