...
/**
 * The dialog for the single selection configuration node
 *
 * @author Christian Albrecht, KNIME GmbH, Konstanz, Germany
 */
public class SingleSelectionDialogNodeNodeDialog
    extends FlowVariableDialogNodeNodeDialog<SingleSelectionDialogNodeValue> {
    ...
    private final SingleSelectionDialogNodeConfig m_config;

    /**
     * Constructor, inits fields calls layout routines
     */
    public SingleSelectionDialogNodeNodeDialog() {
        m_config = new SingleSelectionDialogNodeConfig();
