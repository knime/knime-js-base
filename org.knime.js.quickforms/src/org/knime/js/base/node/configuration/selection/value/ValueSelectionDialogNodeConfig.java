...
/**
 * The config for the value selection configuration node
 *
 * @author Christian Albrecht, KNIME GmbH, Konstanz, Germany
 */
public class ValueSelectionDialogNodeConfig extends LabeledFlowVariableDialogNodeConfig<ValueSelectionDialogNodeValue> {
     ...
     * @return the config
     */
    public ValueSelectionNodeConfig getValueSelectionConfig() {
        return m_config;
    }
     ...
     */
    @Override
    protected ValueSelectionDialogNodeValue createEmptyValue() {
    ...
    public boolean equals(final Object obj) {
        ...
        ValueSelectionDialogNodeConfig other = (ValueSelectionDialogNodeConfig)obj;
