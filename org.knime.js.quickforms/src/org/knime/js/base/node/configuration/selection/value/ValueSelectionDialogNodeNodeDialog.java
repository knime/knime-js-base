...
/**
 * The dialog for the value selection configuration node
 *
 * @author Christian Albrecht, KNIME GmbH, Konstanz, Germany
 */
public class ValueSelectionDialogNodeNodeDialog
    extends FlowVariableDialogNodeNodeDialog<ValueSelectionDialogNodeValue> {
    ...
    private final ValueSelectionDialogNodeConfig m_config;
    ...
    public ValueSelectionDialogNodeNodeDialog() {
        m_config = new ValueSelectionDialogNodeConfig();
