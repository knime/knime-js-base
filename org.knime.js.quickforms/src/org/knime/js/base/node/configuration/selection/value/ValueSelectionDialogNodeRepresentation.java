...
public class ValueSelectionDialogNodeRepresentation
    ...
    public DialogElementRendererSpec getWebUIDialogElementRendererSpec() {
        ...
        final var valueDropdown = getDynamicValueRenderer("Value", domainStateProvider);
        return new LabeledGroupRenderer(this, List.of(columnDropdown.at("column"), valueDropdown.at("value")));
    }
