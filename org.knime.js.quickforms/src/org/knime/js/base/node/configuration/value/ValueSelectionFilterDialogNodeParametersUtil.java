...
public class ValueSelectionFilterDialogNodeParametersUtil {
    ...
    /**
     * Use as a widget title on an {@link AskForColumn} field with a {@link AskForColumnValueReference}.
     */
    public static final String ASK_FOR_COLUMN_TITLE = "Enable column selection";

    /**
     * Use as a widget description on an {@link AskForColumn} field with a {@link AskForColumnValueReference}.
     */
    public static final String ASK_FOR_COLUMN_DESCRIPTION = "Enable column selection:";

    /**
     * The behavior of the column selection in component dialogs of value selection/filter nodes.
     */
    public enum AskForColumn {
            /**
             * It will be possible to select a column
             */
            @Label(value = "Yes", description = "Enable a column to be selected.")
            YES, //
            /**
             * It won't be possible to select a column
             */
    ...
    /**
     * Parameter reference which should be attached to an {@link AskForColumn} field.
     */
    public static final class AskForColumnValueReference implements ParameterReference<AskForColumn> {
    }

    /**
     * Persistor mapping from a boolean to {@link AskForColumn}.
     */
    public abstract static class AbstractAskForColumnPersistor extends EnumBooleanPersistor<AskForColumn> {
        /**
         * @param configKey the config key of the field
         */
        protected AbstractAskForColumnPersistor(final String configKey) {
            super(configKey, AskForColumn.class, AskForColumn.NO_USE_DEFAULT);
        }
    }
