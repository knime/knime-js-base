 ...
 */
package org.knime.js.base.node.parameters.bool;
...
/**
 * Shared parameters for the boolean configuration and widget nodes.
 *
 * @author Robin Gerling
 */
@LoadDefaultsForAbsentFields
public final class BooleanNodeParameters implements NodeParameters {
    ...
    @Persistor(OutputType.OutputTypePersistor.class)
    OutputType m_outputType = OutputType.BOOLEAN;
}
