 ...
 */
package org.knime.js.base.node.parameters.credentials;
...
/**
 * The node parameters for configuration and widget nodes which use the {@link CredentialsNodeValue}.
 *
 * @author Robin Gerling
 */
@SuppressWarnings("restriction")
@LoadDefaultsForAbsentFields
public final class CredentialsNodeParameters implements NodeParameters {
    ...
    static final class DefaultValue implements NodeParameters {
        ...
        /**
         * The cfgKey comes from CredentialsDialogNodeValue which should only be used for configuration nodes, but in
         * this case, it is also used in the widget node ({@link CredentialsInputWidgetConfig#createEmptyValue}).
         */
        ...
        @Modification.WidgetReference(UseServerLoginModificationReference.class)
        boolean m_useServerLoginCredentials;

    }

    /**
     * Reference to the useServerLogin setting of the default value
     */
    public static final class UseServerLoginModificationReference implements Modification.Reference {
    }
