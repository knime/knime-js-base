...
import org.knime.js.base.node.parameters.date.DateNodeParametersDefaultValueUtil.DefaultDateTimeTypeInputValueProvider;
import org.knime.js.base.node.parameters.date.DateNodeParametersDefaultValueUtil.DefaultModification;
import org.knime.js.base.node.parameters.date.DateNodeParametersDefaultValueUtil.DefaultPersistorDateTimeTypeInput;
import org.knime.js.base.node.parameters.date.DateNodeParametersDefaultValueUtil.DefaultPersistorTimeSelection;
import org.knime.js.base.node.parameters.date.DateNodeParametersDefaultValueUtil.DefaultReferenceDateTimeTypeInput;
import org.knime.js.base.node.parameters.date.DateNodeParametersDefaultValueUtil.DefaultReferenceTimeSelection;
import org.knime.js.base.node.parameters.date.DateNodeParametersDefaultValueUtil.TimeSelectionDefaultValue;
import org.knime.js.base.node.parameters.date.DateNodeParametersValidationUtil.MaxDateTimeTypeInputValueProvider;
import org.knime.js.base.node.parameters.date.DateNodeParametersValidationUtil.MaxModification;
import org.knime.js.base.node.parameters.date.DateNodeParametersValidationUtil.MaxPersistorDateTimeTypeInput;
import org.knime.js.base.node.parameters.date.DateNodeParametersValidationUtil.MaxPersistorTimeSelection;
import org.knime.js.base.node.parameters.date.DateNodeParametersValidationUtil.MaxReferenceDateTimeTypeInput;
import org.knime.js.base.node.parameters.date.DateNodeParametersValidationUtil.MaxReferenceTimeSelection;
import org.knime.js.base.node.parameters.date.DateNodeParametersValidationUtil.MinDateTimeTypeInputValueProvider;
import org.knime.js.base.node.parameters.date.DateNodeParametersValidationUtil.MinModification;
import org.knime.js.base.node.parameters.date.DateNodeParametersValidationUtil.MinPersistorDateTimeTypeInput;
import org.knime.js.base.node.parameters.date.DateNodeParametersValidationUtil.MinPersistorTimeSelection;
import org.knime.js.base.node.parameters.date.DateNodeParametersValidationUtil.MinReferenceDateTimeTypeInput;
import org.knime.js.base.node.parameters.date.DateNodeParametersValidationUtil.MinReferenceTimeSelection;
import org.knime.js.base.node.parameters.date.DateNodeParametersValidationUtil.TimeSelectionMinMax;
...
/**
 * Shared WebUI Node Parameters for Date&amp;Time Configuration and Widget.
 *
 * @author Robin Gerling, KNIME GmbH, Konstanz
 */
@SuppressWarnings("restriction")
public class DateNodeParameters implements NodeParameters {
    ...
    static final class DateOverwrittenByValueMessage extends OverwrittenByValueMessage<DateNodeValue> {
        ...
        @Override
        protected String valueToString(final DateNodeValue value) {
