...
public final class LimitVisibleOptionsWidgetModification extends LimitVisibleOptionsParametersModifier {
    ...
    String getLimitNumVisOptionsDescription() {
        return """
                ...
                in case you have too many of them.""";
    }
        ...
        public MinValidation computeState(final NodeParametersInput parametersInput)
            ...
            return new MinValidation() {
                ...
                protected double getMin() {
                    return MIN_NUM_VIS_OPTIONS_NON_COMBOBOX;
                }
    ...
    private static final class NumVisOptionsValueProvider extends AbstractNumVisOptionsValueProvider {
        ...
        public Integer computeState(final NodeParametersInput parametersInput) throws StateComputationFailureException {
            ...
            final var isCombobox = m_selectionTypeSupplier.get().equals(MultipleSelectionsComponentFactory.COMBOBOX);
            return isCombobox ? numVisOptions : Math.max(numVisOptions, MIN_NUM_VIS_OPTIONS_NON_COMBOBOX);
        }
