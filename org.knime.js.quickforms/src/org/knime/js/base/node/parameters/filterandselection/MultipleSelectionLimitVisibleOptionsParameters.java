...
/**
 * The common settings of multiple selection configuration/widgets nodes regarding the limitation of visible options in
 * the frontend component.
 *
 * @author Robin Gerling
 */
@SuppressWarnings("restriction")
public class MultipleSelectionLimitVisibleOptionsParameters implements NodeParameters {
    ...
    private static final class IsListOrTwinlistShowNumberOfVisibleOptions implements EffectPredicateProvider {
        @Override
        public EffectPredicate init(final PredicateInitializer i) {
            return i.getPredicate(IsListOrTwinlistSelectionType.class)
                .and(i.getPredicate(ShowNumberOfVisibleOptions.class));
        }
    }
    ...
    private static final class LimitVisibleOptionsModification extends AdaptTitlesAndDescriptions {
        ...
        Optional<Class<? extends EffectPredicateProvider>> getLimitNumVisOptionsEffectPredicate() {
            return Optional.of(IsListOrTwinlistSelectionType.class);
        }

        @Override
        Class<? extends EffectPredicateProvider> getNumVisOptionsEffectPredicate() {
            return IsListOrTwinlistShowNumberOfVisibleOptions.class;
        }
