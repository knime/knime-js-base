...
public final class SliderNodeParametersUtil {
    ...
    /** Layout section for domain settings (min, max of the slider). */
    @After(FormFieldSection.class)
    @Before(OutputSection.class)
    @Section(title = "Domain")
    public interface DomainSection {
    }
    ...
    @Before(LabelAndPipsSection.class)
    ...
    @Section(title = "Labels & Pips")
    public interface LabelAndPipsSection {
    }
