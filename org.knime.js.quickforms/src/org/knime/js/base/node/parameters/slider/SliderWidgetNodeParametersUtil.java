...
public final class SliderWidgetNodeParametersUtil {
    ...
    /**
     * Choices provider for selecting numeric columns compatible with double sliders. Supports both IntValue and
     * DoubleValue columns.
     */
    public static final class RangeDomainColumnChoicesProvider extends CompatibleColumnsProvider {
        RangeDomainColumnChoicesProvider() {
    ...
    public static final class RangeParameters implements NodeParameters {
        ...
        /**
         * Constructor with initial min and max values.
         *
         * @param min the minimum value
         * @param max the maximum value
         */
        public RangeParameters(final double min, final double max) {
            m_value0 = min;
            m_value1 = max;
        }
