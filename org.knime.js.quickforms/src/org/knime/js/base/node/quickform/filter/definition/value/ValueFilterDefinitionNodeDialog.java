 ...
 */
public class ValueFilterDefinitionNodeDialog extends NodeDialogPane {
     ...
     *
     */
    public ValueFilterDefinitionNodeDialog() {
    ...
    private void updateDefaultField() {
        ...
        String[] possibleValues =
                ValueFilterDefinitionNodeModel.getPossibleValuesForColumn(selectedColumn, m_spec);
    ...
    protected void loadSettingsFrom(final NodeSettingsRO settings, final PortObjectSpec[] specs)
        ...
        if (columnSpec != null) {
            String[] possibleValues =
                ValueFilterDefinitionNodeModel.getPossibleValuesForColumn(columnSpec.getName(), m_spec);
