...
public class CredentialsInputQuickFormDialogPanel extends QuickFormDialogPanel<CredentialsInputQuickFormValue> {
     ...
     *
     */
    public CredentialsInputQuickFormDialogPanel(final CredentialsInputQuickFormRepresentation representation) {
     ...
     */
    @Override
    public CredentialsInputQuickFormValue createNodeValue() throws InvalidSettingsException {
    ...
    /** {@inheritDoc} */
    @Override
    public void loadNodeValue(final CredentialsInputQuickFormValue value) {
    ...
    protected void resetToDefault() {
        final CredentialsInputQuickFormValue defaultValue = getDefaultValue();
