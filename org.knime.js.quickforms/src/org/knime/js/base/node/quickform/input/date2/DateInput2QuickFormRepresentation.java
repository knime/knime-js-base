...
public class DateInput2QuickFormRepresentation extends
        QuickFormRepresentationImpl<DateInput2QuickFormValue, DateInput2QuickFormConfig> {
    ...
    public DateInput2QuickFormRepresentation(final DateInput2QuickFormValue currentValue,
        final DateInput2QuickFormConfig config) {
