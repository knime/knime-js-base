 ...
 *
 * History
 *   28.09.2016 (Christian Albrecht, KNIME.com GmbH, Konstanz, Germany): created
 */
...
/**
 * The value for the slider input quick form node.
 *
 * @author Christian Albrecht, KNIME.com GmbH, Konstanz, Germany
 */
@JsonAutoDetect
@JsonTypeInfo(use = JsonTypeInfo.Id.CLASS, include = JsonTypeInfo.As.PROPERTY, property = "@class")
public class SliderInputQuickFormValue extends JSONViewContent implements DialogNodeValue {
    ...
    public boolean equals(final Object obj) {
        ...
        SliderInputQuickFormValue other = (SliderInputQuickFormValue)obj;
    ...
    public JsonObject toJson() {
        JsonObject value = JsonUtil.getProvider().createObjectBuilder()
