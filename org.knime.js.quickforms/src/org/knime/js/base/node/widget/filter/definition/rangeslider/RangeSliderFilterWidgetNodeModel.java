 ...
 */
public class RangeSliderFilterWidgetNodeModel extends AbstractWizardNodeModel<RangeSliderFilterWidgetRepresentation,
        RangeFilterWidgetValue> implements CSSModifiable {

    private UUID m_filterId;

    private final RangeSliderFilterWidgetConfig m_config;
     ...
     */
    public RangeSliderFilterWidgetNodeModel(final String viewName) {
        super(new PortType[]{BufferedDataTable.TYPE},
            new PortType[]{BufferedDataTable.TYPE, FilterDefinitionHandlerPortObject.TYPE}, viewName);
        m_config = new RangeSliderFilterWidgetConfig();
    }
    ...
    public String getJavascriptObjectID() {
        return "org.knime.js.base.node.widget.filter.definition.slider";
    }
    ...
    private void disableSlider(final boolean disable) {
        RangeSliderFilterWidgetRepresentation rep = getViewRepresentation();
        if (rep != null) {
     ...
     */
    @Override
    public RangeSliderFilterWidgetRepresentation createEmptyViewRepresentation() {
        return new RangeSliderFilterWidgetRepresentation(m_config);
    }
     ...
     */
    @Override
    public RangeSliderFilterWidgetRepresentation getViewRepresentation() {
        RangeSliderFilterWidgetRepresentation rep = super.getViewRepresentation();
        synchronized(getLock()) {
    ...
    protected void validateSettings(final NodeSettingsRO settings) throws InvalidSettingsException {
        (new RangeSliderFilterWidgetConfig()).loadSettings(settings);
    }
