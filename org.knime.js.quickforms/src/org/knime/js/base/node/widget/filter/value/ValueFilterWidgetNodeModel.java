 ...
 */
public class ValueFilterWidgetNodeModel extends WidgetNodeModel< //
        ReExecutableValueFilterNodeRepresentation<ValueFilterNodeValue>, ValueFilterNodeValue, ValueFilterWidgetConfig>
    ...
    protected ValueFilterNodeValue copyConfigToViewValue(final ValueFilterNodeValue currentViewValue,
        ...
        if (!Arrays.equals(defaultVal.getValues(), previousDefaultVal.getValues())
            && (config.isIgnoreInvalidValues() || currentViewValue.getValues().length == 0)) {
    ...
    protected ReExecutableValueFilterNodeRepresentation<ValueFilterNodeValue> getRepresentation() {
        ...
        return new ReExecutableValueFilterNodeRepresentation<>(getRelevantValue(), config.getDefaultValue(),
            config.getValueFilterConfig(), config.getLabelConfig(), config.isEnableSearch(),
