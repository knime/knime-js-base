...
public final class BooleanWidgetNodeSettings implements NodeParameters {
    ...
    String m_parameter = "boolean-input";
    ...
    @Layout(WidgetNodeSettingsBase.CommonSections.ParameterSection.class)
    @Persistor(CommonWidgetPersistors.BooleanDefaultValuePersistor.class)
    boolean m_defaultValue = false;
