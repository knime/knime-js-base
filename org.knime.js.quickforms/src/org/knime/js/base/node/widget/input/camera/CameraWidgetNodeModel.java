 ...
 */
public class CameraWidgetNodeModel
    extends WidgetFlowVariableNodeModel<CameraNodeRepresentation<StringNodeValue>, StringNodeValue, CameraInputWidgetConfig> {

    /**
     * @param viewName
     */
    public CameraWidgetNodeModel(final String viewName) {
        super(viewName);
    }
    ...
    public String getJavascriptObjectID() {
        return "org.knime.js.base.node.widget.input.camera";
    }
     ...
     */
    @Override
    public CameraInputWidgetConfig createEmptyConfig() {
        return new CameraInputWidgetConfig();
    }
