...
/**
 * Node dialog for the credentials widget node
 *
 * @author Daniel Bogenrieder, KNIME GmbH, Konstanz, Germany
 */
public class CredentialsWidgetNodeDialog extends FlowVariableWidgetNodeDialog<CredentialsNodeValue> {
    ...
    private final CredentialsInputWidgetConfig m_config;

    /** Constructors, inits fields calls layout routines. */
    CredentialsWidgetNodeDialog() {
        ...
        m_promptUsernameChecker = new JCheckBox("Prompt user name in widget view");
    ...
    protected String getValueString(final NodeSettingsRO settings) throws InvalidSettingsException {
        CredentialsNodeValue value = new CredentialsNodeValue();
    ...
    protected void loadSettingsFrom(final NodeSettingsRO settings, final PortObjectSpec[] specs)
        ...
        final CredentialsNodeValue defaultValue = m_config.getDefaultValue();
