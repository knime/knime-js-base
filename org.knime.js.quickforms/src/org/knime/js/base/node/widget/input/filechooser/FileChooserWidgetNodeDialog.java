...
/**
 * Node dialog for the file chooser widget node
 *
 * @author Christian Albrecht, KNIME GmbH, Konstanz, Germany
 */
public class FileChooserWidgetNodeDialog extends FlowVariableWidgetNodeDialog<FileChooserNodeValue>
    ...
    private final FileChooserInputWidgetConfig m_config;

    /**
     * Constructor, inits fields calls layout routines
     */
    public FileChooserWidgetNodeDialog() {
        m_config = new FileChooserInputWidgetConfig();
    ...
    protected String getValueString(final NodeSettingsRO settings) throws InvalidSettingsException {
        FileChooserNodeValue value = new FileChooserNodeValue();
