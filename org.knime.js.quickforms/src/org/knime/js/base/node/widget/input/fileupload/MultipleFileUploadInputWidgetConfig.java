...
public class MultipleFileUploadInputWidgetConfig extends LabeledWidgetConfig<MultipleFileUploadNodeValue> {
     ...
     */
    public MultipleFileUploadInputWidgetConfig() {
        m_config = new MultipleFileUploadNodeConfig();
    }

    /**
     * @return the config
     */
    public MultipleFileUploadNodeConfig getFileUploadConfig() {
        return m_config;
    }
     ...
     */
    @Override
    protected MultipleFileUploadNodeValue createEmptyValue() {
    ...
    public boolean equals(final Object obj) {
        ...
        MultipleFileUploadInputWidgetConfig other = (MultipleFileUploadInputWidgetConfig)obj;
