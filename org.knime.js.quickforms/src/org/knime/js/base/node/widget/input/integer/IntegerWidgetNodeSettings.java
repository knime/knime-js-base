...
public final class IntegerWidgetNodeSettings implements NodeParameters {
    ...
    String m_parameter = "integer-input";
    ...
    @Layout(WidgetNodeSettingsBase.CommonSections.ParameterSection.class)
    @NumberInputWidget
    @Persistor(CommonWidgetPersistors.IntegerDefaultValuePersistor.class)
    ...
    // Validation settings specific to integer input
    ...
    @Widget(title = "Use minimum", description = "Check to enforce a minimum value")
    ...
    @Widget(title = "Minimum", description = "The minimum allowed value")
    @Layout(WidgetNodeSettingsBase.CommonSections.ValidationSection.class)
    @NumberInputWidget
    @Persist(configKey = "min")
    int m_min = 0;

    @Widget(title = "Use maximum", description = "Check to enforce a maximum value")
    @Layout(WidgetNodeSettingsBase.CommonSections.ValidationSection.class)
    @Persist(configKey = "useMax")
    @ValueReference(UseMaxRef.class)
    boolean m_useMax = false;

    @Widget(title = "Maximum", description = "The maximum allowed value")
    @Layout(WidgetNodeSettingsBase.CommonSections.ValidationSection.class)
    @NumberInputWidget
    ...
    /**
     * Predicate for showing minimum value field when "Use minimum" is checked.
     */

    /**
     * Predicate for showing maximum value field when "Use maximum" is checked.
     */
}
