...
/**
 * Node dialog for the slider widget node
 *
 * @author Daniel Bogenrieder, KNIME GmbH, Konstanz, Germany
 */
public class SliderWidgetNodeDialog extends FlowVariableWidgetNodeDialog<SliderNodeValue> {
    ...
    private SliderInputWidgetConfig m_config;
    ...
    SliderWidgetNodeDialog() {
        m_config = new SliderInputWidgetConfig();
    ...
    private final void createSliderTab() {
        ...
        JPanel tooltipPanel = new JPanel(new GridBagLayout());
        GridBagConstraints gbc3 = new GridBagConstraints();
        gbc3.anchor = GridBagConstraints.NORTHWEST;
        gbc3.fill = GridBagConstraints.HORIZONTAL;
        gbc3.gridx = gbc3.gridy = 0;
        gbc3.weightx = 0;
        tooltipPanel.add(m_tooltipsCheckbox, gbc3);
        gbc3.gridx++;
        gbc3.weightx = 1;
        tooltipPanel.add(m_tooltipsFormatCheckbox, gbc3);
        addPairToPanel("", tooltipPanel, panel, gbc);
    ...
    protected void loadSettingsFrom(final NodeSettingsRO settings, final PortObjectSpec[] specs)
        ...
        m_useMin.setSelected(m_config.isUseCustomMin());
        m_useMax.setSelected(m_config.isUseCustomMax());
