...
import org.knime.js.base.node.parameters.slider.SliderPipsSettingsNodeParameters;
...
public final class SliderWidgetSliderSettingsNodeParameters implements NodeParameters {
    ...
    @Layout(SliderBehaviourSection.class)
    @Persistor(OrientationAndDirectionParameters.OrientationAndDirectionPersistor.class)
    ...
    SliderPipsSettingsNodeParameters m_pips = new SliderPipsSettingsNodeParameters();
