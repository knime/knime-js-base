 ...
 */
public class ImageOutputWidgetDialog extends LabeledViewNodeDialog {
    ...
    private final ImageOutputWidgetConfig m_config;

    /**
     * Create new dialog.
     */
    public ImageOutputWidgetDialog() {
        m_config = new ImageOutputWidgetConfig();
