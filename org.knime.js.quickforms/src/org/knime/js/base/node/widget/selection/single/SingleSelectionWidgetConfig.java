...
/**
 * The config for the single selection widget node
 *
 * @author Christian Albrecht, KNIME GmbH, Konstanz, Germany
 */
public class SingleSelectionWidgetConfig extends LabeledFlowVariableWidgetConfig<SingleMultipleSelectionNodeValue> {
     ...
     *
     */
    public SingleSelectionWidgetConfig() {
    ...
    public boolean equals(final Object obj) {
        ...
        SingleSelectionWidgetConfig other = (SingleSelectionWidgetConfig)obj;
