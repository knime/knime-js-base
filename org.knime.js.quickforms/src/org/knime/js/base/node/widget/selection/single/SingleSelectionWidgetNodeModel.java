...
/**
 * The node model for the single selection widget node
 *
...
public class SingleSelectionWidgetNodeModel extends
     ...
     */
    public SingleSelectionWidgetNodeModel(final String viewName) {
        super(viewName);
    }
    ...
    public String getJavascriptObjectID() {
        return "org.knime.js.base.node.widget.selection.single";
    }
     ...
     */
    @Override
    public SingleSelectionWidgetConfig createEmptyConfig() {
        return new SingleSelectionWidgetConfig();
    }
