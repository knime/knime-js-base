window.requestHandler = (function () {

    var handler = {};
    var _representation, _value, textArea;
    var curRequests = [];
    ...
    handler.init = function (representation, value) {
        ...
        if (_representation.stallRequests) {
            ...
            } else if (_representation.keepOrder) {
        ...
        knimeService.addButton('dummy-request', 'paper-plane', 'Send Dummy Request', function () {
            ...
            if (knimeService.isViewRequestsSupported()) {
                handler.initRequest(request, textArea, _representation, curRequests);
            } else {
    ...
    var pad = function (number, padAmount) {
