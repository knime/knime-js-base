...
class ValueFilterConfigurationComponentDialogTest extends IntegratedComponentDialogTestBase {
    ...
    void testValueFilterConfigurationList() throws JsonProcessingException {
        ...
        assertThatJson(uiSchema).inPath("$.elements[4].elements[1].scope").isString()
            .isEqualTo(String.format("#/properties/model/properties/list-7/properties/values"));
        ...
        assertThatJson(uiSchema).inPath("$.elements[5].scope").isString()
            .isEqualTo(String.format("#/properties/model/properties/list-locked-11/properties/values"));
    ...
    void testValueFilterConfigurationCheckboxes() throws JsonProcessingException {
        ...
        assertThatJson(uiSchema).inPath("$.elements[6].elements[1].scope").isString()
            .isEqualTo(String.format("#/properties/model/properties/checkboxes-horizontal-8/properties/values"));
        ...
        assertThatJson(uiSchema).inPath("$.elements[7].scope").isString().isEqualTo(
            String.format("#/properties/model/properties/checkboxes-horizontal-locked-13/properties/values"));
        ...
        assertThatJson(uiSchema).inPath("$.elements[8].elements[1].scope").isString()
            .isEqualTo(String.format("#/properties/model/properties/checkboxes-vertical-9/properties/values"));
        ...
        assertThatJson(uiSchema).inPath("$.elements[9].scope").isString()
            .isEqualTo(String.format("#/properties/model/properties/checkboxes-vertical-locked-14/properties/values"));
    ...
    void testValueFilterConfigurationComboBox() throws JsonProcessingException {
        ...
        assertThatJson(uiSchema).inPath("$.elements[10].elements[1].scope").isString()
            .isEqualTo(String.format("#/properties/model/properties/combobox-10/properties/values"));
        ...
        assertThatJson(uiSchema).inPath("$.elements[11].scope").isString()
            .isEqualTo(String.format("#/properties/model/properties/combobox-locked-15/properties/values"));
