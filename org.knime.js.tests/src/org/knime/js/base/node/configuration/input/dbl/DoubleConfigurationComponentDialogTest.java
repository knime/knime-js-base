...
class DoubleConfigurationComponentDialogTest extends IntegratedComponentDialogTestBase {

    @Test
    void testDoubleConfigurationComponentDialog() throws JsonProcessingException {
    ...
    @Test
    void testDoubleConfigurationComponentDialogWithMinAndMax() throws JsonProcessingException {
        final var dialogData = getComponentDialog(getTopLevelNodeId(2));
        final var paramName = "double-input-with-min-and-max-4";
        final var uiSchema = dialogData.getUiSchema();
