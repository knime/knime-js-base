...
class FilechooserConfigurationComponentDialogTest extends IntegratedComponentDialogTestBase {
    ...
    void testFileChooserConfigurationComponentDialog() throws JsonProcessingException {
        ...
        assertThatJson(data).inPath("$.items.item_1.path").isString().isEqualTo("knime://LOCAL/Data/iris_setosa.csv");
        assertThatJson(data).inPath("$.items.item_1.type").isString().isEqualTo("UNKNOWN");
        ...
        assertThatJson(schema).inPath("$.properties.items.properties.item_0.title").isString().isEqualTo("File chooser label");
        ...
        assertThatJson(persistSchema).inPath(
            ...
            .isArray().isEqualTo(new String[][]{{"num_items"}, {"item_0", "path"}, {"item_0", "type"}});
    }
