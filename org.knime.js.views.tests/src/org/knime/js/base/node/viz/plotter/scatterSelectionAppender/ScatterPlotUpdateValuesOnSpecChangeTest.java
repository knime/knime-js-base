 ...
 */
public class ScatterPlotUpdateValuesOnSpecChangeTest extends AbstractUpdateViewValuesOnSpecChangeTest {

    @SuppressWarnings("javadoc")
    public ScatterPlotUpdateValuesOnSpecChangeTest() {
        super(ScatterPlotNodeFactory.class.getName(), Map.of(//
