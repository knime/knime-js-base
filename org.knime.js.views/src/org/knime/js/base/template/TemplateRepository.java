...
public abstract class TemplateRepository {
     ...
     */
    public abstract boolean isRemoveable(final JSTemplate template);
     ...
     */
    public abstract boolean removeTemplate(final JSTemplate template);
     ...
     */
    public abstract JSTemplate getTemplate(final UUID id);
     ...
     */
    public abstract String getDisplayLocation(final JSTemplate template);
