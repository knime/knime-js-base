...
/**
 * The panel which displays and previews templates for JS views
 *
...
public class TemplatesPanel extends JPanel {
    ...
    private final JList<JSTemplate> m_templates;
     ...
     * @param controller the controller used to create the preview and apply templates
     */
    public TemplatesPanel(final Set<Class<?>> set, final TemplateController controller) {
        ...
        m_templates = new JList<>(new DefaultListModel<JSTemplate>());
    ...
    private void onSelectionInTemplateList(final Object selected) {
        ...
        if (selected != null) {
            final JSTemplate template = (JSTemplate)selected;
    ...
    private void updateTemplatesList(final String category) {
        final Object selected = m_templates.getSelectedValue();
        final DefaultListModel<JSTemplate> model = (DefaultListModel<JSTemplate>)m_templates.getModel();
        model.clear();
        final TemplateProvider provider = TemplateProvider.getDefault();
        for (final JSTemplate template : provider.getTemplates(m_metaCategories, category)) {
    ...
    private static class TemplateListCellRenderer extends DefaultListCellRenderer {
        ...
        public Component getListCellRendererComponent(final JList list, final Object value, final int index,
            ...
            final JSTemplate m = (JSTemplate)value;
    ...
    private JPanel createTemplatesPanel() {
        ...
        m_applyTemplateButton.addActionListener(new ActionListener() {
            ...
            @Override
            public void actionPerformed(final ActionEvent e) {
                final JSTemplate template = m_templates.getSelectedValue();
                if (null != template) {
