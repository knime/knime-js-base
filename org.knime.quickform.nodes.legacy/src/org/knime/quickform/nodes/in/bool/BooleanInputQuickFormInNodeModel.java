 ...
 * @since 2.6
 */
public class BooleanInputQuickFormInNodeModel extends
        QuickFormInNodeModel<BooleanInputQuickFormInConfiguration> {

    /** {@inheritDoc} */
    @Override
    protected void createAndPushFlowVariable() throws InvalidSettingsException {
        BooleanInputQuickFormInConfiguration cfg = getConfiguration();
        if (cfg == null) {
            throw new InvalidSettingsException("No settings available");
        }
        String variableName = cfg.getVariableName();
        boolean value = cfg.getValueConfiguration().getValue();
        pushFlowVariableInt(variableName, value ? 1 : 0);
    }

    /** {@inheritDoc} */
    @Override
    public BooleanInputQuickFormInConfiguration createConfiguration() {
        return new BooleanInputQuickFormInConfiguration();
    }
    ...
    public AbstractQuickFormInElement getQuickFormElement() {
        BooleanInputQuickFormInConfiguration cfg = getConfiguration();
        CheckboxInputQuickFormInElement e =
                new CheckboxInputQuickFormInElement(cfg.getLabel(),
    ...
    public void loadFromQuickFormElement(final AbstractQuickFormInElement e)
        ...
        BooleanInputQuickFormInConfiguration cfg = getConfiguration();
        CheckboxInputQuickFormInElement si =
