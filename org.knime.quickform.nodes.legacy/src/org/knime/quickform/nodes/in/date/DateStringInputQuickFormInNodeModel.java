...
/**
 * Node for date input (as string variable).
 *
 * @author ohl, University of Konstanz
 */
public class DateStringInputQuickFormInNodeModel extends
        QuickFormInNodeModel<DateStringInputQuickFormInConfiguration> {

    /** {@inheritDoc} */
    @Override
    protected void createAndPushFlowVariable() throws InvalidSettingsException {
        DateStringInputQuickFormInConfiguration cfg = getConfiguration();
        if (cfg == null) {
            throw new InvalidSettingsException("No settings available");
        }
        String variableName = cfg.getVariableName();
        Date value = cfg.getValueConfiguration().getValue();
        if (value == null) {
            throw new InvalidSettingsException("Date field must not be null");
        }
        pushFlowVariableString(variableName,
            new SimpleDateFormat(DateStringInputQuickFormInElement.FORMAT).format(value));
    }
    ...
    public AbstractQuickFormInElement getQuickFormElement() {
        DateStringInputQuickFormInConfiguration cfg = getConfiguration();
        DateStringInputQuickFormInElement e =
                new DateStringInputQuickFormInElement(cfg.getLabel(),
    ...
    public void loadFromQuickFormElement(final AbstractQuickFormInElement e)
        ...
        DateStringInputQuickFormInConfiguration cfg = getConfiguration();
        DateStringInputQuickFormInElement si =
