 ...
 */
final class DateStringInputQuickFormPanel
    extends QuickFormConfigurationPanel<DateStringInputQuickFormValueInConfiguration> {

    private final JFormattedTextField m_valueField;
    private final JLabel m_label;

    /** Constructors, inits fields calls layout routines. */
    DateStringInputQuickFormPanel(final DateStringInputQuickFormInConfiguration cfg) {
        ...
        m_valueField.setColumns(QuickFormInNodeDialogPane.DEF_TEXTFIELD_WIDTH);
    ...
    /** {@inheritDoc} */
    @Override
    public void loadSettings(final DateStringInputQuickFormValueInConfiguration config) {
        loadValueConfig(config);
    }

    private void loadValueConfig(
            final DateStringInputQuickFormValueInConfiguration config) {
        m_valueField.setValue(config.getValue());
    }

    /** {@inheritDoc} */
    @Override
    public void saveSettings(final DateStringInputQuickFormValueInConfiguration config)
    ...
    public void updateQuickFormInElement(final AbstractQuickFormInElement e) throws InvalidSettingsException {
        DateStringInputQuickFormInElement cast =
            AbstractQuickFormElement.cast(
                    DateStringInputQuickFormInElement.class, e);
        cast.setValue(getDate());
    }

    private Date getDate() throws InvalidSettingsException {
        try {
        ...
        return (Date)m_valueField.getValue();
    }
