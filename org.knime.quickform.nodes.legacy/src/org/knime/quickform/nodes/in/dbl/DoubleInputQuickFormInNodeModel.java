...
/**
 * Node for double input.
 *
 * @author ohl, University of Konstanz
 */
public class DoubleInputQuickFormInNodeModel extends
        QuickFormInNodeModel<DoubleInputQuickFormInConfiguration> {

    /** {@inheritDoc} */
    @Override
    protected void createAndPushFlowVariable() throws InvalidSettingsException {
        DoubleInputQuickFormInConfiguration cfg = getConfiguration();
        if (cfg == null) {
            throw new InvalidSettingsException("No settings available");
        }
        String variableName = cfg.getVariableName();
        double value = cfg.getValueConfiguration().getValue();
        pushFlowVariableDouble(variableName, value);
    }

    /** {@inheritDoc} */
    @Override
    public DoubleInputQuickFormInConfiguration createConfiguration() {
    ...
    public AbstractQuickFormInElement getQuickFormElement() {
        DoubleInputQuickFormInConfiguration cfg = getConfiguration();
        DoubleInputQuickFormInElement e =
                new DoubleInputQuickFormInElement(cfg.getLabel(),
    ...
    public void loadFromQuickFormElement(final AbstractQuickFormInElement e)
        ...
        DoubleInputQuickFormInConfiguration cfg = getConfiguration();
        DoubleInputQuickFormInElement si =
