 ...
 */
final class DoubleInputQuickFormValueInConfiguration
    ...
    public void saveValue(final NodeSettingsWO settings) {
        settings.addDouble("value", m_value);
    }
    ...
    public void loadValueInModel(final NodeSettingsRO settings)
        ...
        m_value = settings.getDouble("value");
    }

    /** {@inheritDoc} */
    @Override
    public void loadValueInDialog(final NodeSettingsRO settings) {
        m_value = settings.getDouble("value", 0.0);
    }
