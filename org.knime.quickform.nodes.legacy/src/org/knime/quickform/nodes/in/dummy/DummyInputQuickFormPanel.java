 ...
 */
final class DummyInputQuickFormPanel extends
    QuickFormConfigurationPanel<DummyInputQuickFormValueInConfiguration> {


    /** Constructors, inits fields calls layout routines. */
    DummyInputQuickFormPanel(final DummyInputQuickFormInConfiguration cfg) {
    ...
    public void saveSettings(
            final DummyInputQuickFormValueInConfiguration config)
            throws InvalidSettingsException {
        // no save in wizard page
    }
