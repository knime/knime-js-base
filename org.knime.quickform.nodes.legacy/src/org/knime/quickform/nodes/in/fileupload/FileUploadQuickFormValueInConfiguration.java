 ...
 */
public final class FileUploadQuickFormValueInConfiguration extends
    ...
    public void setLocation(final String file) {
        m_location = file;
    }
    ...
    public void loadValueInDialog(final NodeSettingsRO settings) {
        m_location = settings.getString("location", null);
    }
