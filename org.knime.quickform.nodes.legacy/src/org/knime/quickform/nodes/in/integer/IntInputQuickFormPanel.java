 ...
 */
package org.knime.quickform.nodes.in.integer;
...
import org.knime.core.util.node.quickform.in.IntInputQuickFormInElement;
 ...
 */
final class IntInputQuickFormPanel extends
    QuickFormConfigurationPanel<IntInputQuickFormValueInConfiguration> {

    private final JTextField m_valueField;
    private final JLabel m_label;

    /** Constructors, inits fields calls layout routines. */
    IntInputQuickFormPanel(final IntInputQuickFormInConfiguration cfg) {
    ...
    public void saveSettings(
            final IntInputQuickFormValueInConfiguration config)
            throws InvalidSettingsException {
        config.setValue(getInteger());
    }
    ...
    public void updateQuickFormInElement(final AbstractQuickFormInElement e)
            throws InvalidSettingsException {
        IntInputQuickFormInElement cast =
            AbstractQuickFormInElement.cast(
                    IntInputQuickFormInElement.class, e);
        cast.setValue(getInteger());
    }

    private Integer getInteger() throws InvalidSettingsException {
        Integer i;
        try {
            i = Integer.parseInt(m_valueField.getText());
        } catch (NumberFormatException e) {
            throw new InvalidSettingsException(
                    "Please provide a valid integer value for \""
                    + m_label.getText() + "\".");
        }
        return i;
    }
