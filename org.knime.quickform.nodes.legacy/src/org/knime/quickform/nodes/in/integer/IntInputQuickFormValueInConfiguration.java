...
/**
 * Configuration to int input node.
 * @author Peter Ohl, KNIME.com, Zurich, Switzerland
 */
final class IntInputQuickFormValueInConfiguration
    ...
    public void loadValueInModel(final NodeSettingsRO settings)
        ...
        m_value = settings.getInt("value");
    }

    /** {@inheritDoc} */
    @Override
    public void loadValueInDialog(final NodeSettingsRO settings) {
        m_value = settings.getInt("value", 0);
    }
