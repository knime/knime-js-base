...
final class MultiSelectionInputQuickFormInConfiguration
    ...
    /** Option to determine, if the UI component should be a one-line element only. */
    ...
    /**
     * Determines, if the UI that the user sees for selections shall
     ...
     * 
     * @return True, if small UI component is desired, false otherwise.
     */
    boolean isSmallGui() {
        return m_bSmallGui;
    }
    ...
    /**
     * Sets the option that the UI that the user sees for selections shall
     * be extra small, usually a one-line element. If set, a click
     * on such a one-line element will open a popup to see the full
     * list of choices and do the selections.
     * 
     * @param b Set to true, if small UI component is desired. False otherwise.
     */
    void setSmallGui(final boolean b) {
        m_bSmallGui = b;
    }
