...
import org.knime.core.util.node.quickform.in.StringListInputQuickFormInElement;
...
public class MultiSelectionInputQuickFormPanel extends
    ...
    public MultiSelectionInputQuickFormPanel(
        ...
        if (choices == null || choices.length == 0) {
            ...
            if (cfg.isSmallGui()) {
                ...
                m_listPanel = new MultiSelectionListPanel(cfg.getChoices(), 7, true);
    ...
    public void updateQuickFormInElement(final AbstractQuickFormInElement e) throws InvalidSettingsException {
        StringListInputQuickFormInElement cast = AbstractQuickFormElement.cast(
                StringListInputQuickFormInElement.class, e);
        if (m_listPanel != null) {
    ...
    /**
     * Returns the currently selected values from the multi-selection list.
     *
     * @return Array of selected values. Never null, but possibly empty.
     */
    private String[] getSelectedValues() {
        final Object[] arrSelectedValues = m_listPanel.getSelections();
        final String[] arrSelectedStrings = new String[arrSelectedValues == null ? 0 : arrSelectedValues.length];
