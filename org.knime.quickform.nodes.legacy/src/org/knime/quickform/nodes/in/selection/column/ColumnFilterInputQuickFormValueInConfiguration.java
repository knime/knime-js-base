...
/**
 * Configuration for a column selection. Keeps list of currently selected values
 * and list of possible values.
 *
 * @author Thomas Gabriel, KNIME AG, Zurich, Switzerland
 * @since 2.6
 */
final class ColumnFilterInputQuickFormValueInConfiguration
    ...
    /** @param values the value to set (no check will be done if this value
