...
/**
 * Configuration for a multiple String selection (multiple choices).
 * @author Thomas Gabriel, KNIME.com, Zurich, Switzerland
 */
final class MultipleSelectionInputQuickFormInConfiguration
    extends AbstractQuickFormConfiguration<MultipleSelectionInputQuickFormValueInConfiguration> {
    ...
    public void saveSettingsTo(final NodeSettingsWO settings) {
        ...
        settings.addString("choices", m_choices);
    }
    ...
    public void loadSettingsInModel(final NodeSettingsRO settings)
        ...
        m_choices = settings.getString("choices");
        if (m_choices == null) {
            m_choices = "";
        }
    }
    ...
    /** {@inheritDoc} */
    @Override
    public MultipleSelectionInputQuickFormPanel createController() {
        return new MultipleSelectionInputQuickFormPanel(this);
    }

    /** {@inheritDoc} */
    @Override
    public MultipleSelectionInputQuickFormValueInConfiguration
        createValueConfiguration() {
        return new MultipleSelectionInputQuickFormValueInConfiguration();
    }
