...
/**
 * Configuration for a single String selection (one of multiple choices).
 * @author Thomas Gabriel, KNIME.com, Zurich, Switzerland
 */
final class SingleSelectionInputQuickFormInConfiguration
    extends AbstractQuickFormConfiguration<SingleSelectionInputQuickFormValueInConfiguration> {
    ...
    /** {@inheritDoc} */
    @Override
    public SingleSelectionInputQuickFormPanel createController() {
        return new SingleSelectionInputQuickFormPanel(this);
    }

    /** {@inheritDoc} */
    @Override
    public SingleSelectionInputQuickFormValueInConfiguration
        createValueConfiguration() {
        return new SingleSelectionInputQuickFormValueInConfiguration();
    }
