 ...
 * @since 2.6
 */
final class ValueFilterInputQuickFormInConfiguration
    ...
    /** {@inheritDoc} */
    @Override
    public ValueFilterInputQuickFormPanel createController() {
        return new ValueFilterInputQuickFormPanel(this);
    }


    /** {@inheritDoc} */
    @Override
    public ValueFilterInputQuickFormValueInConfiguration
            createValueConfiguration() {
        return new ValueFilterInputQuickFormValueInConfiguration();
    }
