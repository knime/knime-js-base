 ...
 */
final class StringInputQuickFormPanel extends
    QuickFormConfigurationPanel<StringInputQuickFormValueInConfiguration> {

    private final JTextField m_valueField;

    /** Constructors, inits fields calls layout routines. */
    StringInputQuickFormPanel(final StringInputQuickFormInConfiguration cfg) {
    ...
    public void saveSettings(
            final StringInputQuickFormValueInConfiguration config)
    ...
    public void updateQuickFormInElement(final AbstractQuickFormInElement e) throws InvalidSettingsException {
        StringInputQuickFormInElement cast = AbstractQuickFormInElement.cast(
