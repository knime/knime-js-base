 ...
 */
public class StringSelectionInputQuickFormInNodeModel extends
        QuickFormInNodeModel<StringSelectionInputQuickFormInConfiguration> {

    /** {@inheritDoc} */
    @Override
    protected void createAndPushFlowVariable() throws InvalidSettingsException {
        StringSelectionInputQuickFormInConfiguration cfg = getConfiguration();
        if (cfg == null) {
        ...
        final ArrayList<String> alist = new ArrayList<String>(
                Arrays.asList(cfg.getChoices()));
        pushFlowVariableInt(variableName + " (Index)", alist.indexOf(value));
    }

    /** {@inheritDoc} */
    @Override
    protected StringSelectionInputQuickFormInConfiguration
            createConfiguration() {
    ...
    public AbstractQuickFormInElement getQuickFormElement() {
        StringSelectionInputQuickFormInConfiguration cfg = getConfiguration();
        StringSelectionInputQuickFormInElement e =
                new StringSelectionInputQuickFormInElement(cfg.getLabel(),
    ...
    public void loadFromQuickFormElement(final AbstractQuickFormInElement e)
        ...
        StringSelectionInputQuickFormInConfiguration cfg = getConfiguration();
        StringSelectionInputQuickFormInElement si =
                AbstractQuickFormInElement.cast(
                        StringSelectionInputQuickFormInElement.class, e);
