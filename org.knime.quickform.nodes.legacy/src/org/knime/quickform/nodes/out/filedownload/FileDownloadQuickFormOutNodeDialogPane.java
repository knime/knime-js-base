...
/**
 * Dialog for file download.
 *
 * @author Bernd Wiswedel, KNIME.com, Zurich, Switzerland
 */
public class FileDownloadQuickFormOutNodeDialogPane extends
        QuickFormOutNodeDialogPane<FileDownloadQuickFormOutConfiguration> {

    private final JComboBox m_filePathVariableNameCombo;

    /** Create new dialog.
     */
    public FileDownloadQuickFormOutNodeDialogPane() {
    ...
    protected void saveAdditionalSettings(
            final FileDownloadQuickFormOutConfiguration config)
            throws InvalidSettingsException {
        FlowVariable v =
            (FlowVariable)m_filePathVariableNameCombo.getSelectedItem();
        if (v != null) {
            config.setFilePathVariableName(v.getName());
        }
    }
