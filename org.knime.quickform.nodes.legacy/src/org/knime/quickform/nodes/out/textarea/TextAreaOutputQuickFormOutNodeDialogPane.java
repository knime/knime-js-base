 ...
 */
public class TextAreaOutputQuickFormOutNodeDialogPane extends
        QuickFormOutNodeDialogPane<TextAreaOutputQuickFormOutConfiguration> {
    ...
    TextAreaOutputQuickFormOutNodeDialogPane() {
        m_textFormatBox = new JComboBox(TextFormat.values());
    ...
    protected void saveAdditionalSettings(
            final TextAreaOutputQuickFormOutConfiguration config)
            throws InvalidSettingsException {
        String s = m_textArea.getText();
        config.setText(s);
        config.setTextFormat((TextFormat)m_textFormatBox.getSelectedItem());
    }
